...
class xml_Administration(XMLContent):
    ...
    def snmpTrapTest(self):
        ...
        result.appendChild(self.doc.createTextNode('SNMP subsystem notified to send a test trap.'))
        self.doc.documentElement.appendChild(result)
        self.writeXmlDoc()
...
class json_Administration(JSONContent):
    alwaysKeepAliveList = [
        'webCertReplace'
    ]
    ...
    #
    # We also may receive the <tt>appliancePolicyPrefix</tt> field telling us
    # the appliance policy prefix to use if we are dealing with a CMC managed
    # appliance.
    #
    ...
    def webCertReplace(self):
        def internal(**kw):
            ...
            if 'appliancePolicyPrefix' in kw:
                ...
                actionBase = kw['appliancePolicyPrefix']
            ...
            try:
                ...
                if kw['certMode'] == 'import1':
                    ...
                    code, msg, bindings = self.mgmt.actionResults(
                        actionBase + '/web/action/httpd/ssl/cert/import',
                ...
                # Generate a new cert.
                    ...
                    code, msg, bindings = self.mgmt.actionResults(
                        actionBase + '/web/action/httpd/ssl/cert/generate',
