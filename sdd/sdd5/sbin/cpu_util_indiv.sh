#!/bin/bash
# $Id: cpu_util_indiv.sh 103995 2013-03-25 23:25:20Z wtai $
# $URL: svn://svn.nbttech.com/mgmt-fwk/branches/kauai_373_fix_branch/framework/src/base_os/common/script_files/cpu_util_indiv.sh $
# ---------------------------------------------------------------------------
...
# If this is a VM, then reload the modules with timer set
