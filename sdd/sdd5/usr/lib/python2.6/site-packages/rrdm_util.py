...
class RaidSuper:
    ...
    def uuid(self):
	    ...
	    return self.__lookup_field('Array UUID')
        else:
    ...
    def get_role(self):                                            
        role = self.__lookup_field('Device Role')                       
        role = "".join([ch for ch in role if ch in digits])             
        return int(role)
...
model_to_ssdinfo_map = { "ATP Industrial S":SSDDiskWearInfo(524288,15360),
			 ...
			 "INTEL SSDSC2BA10":SSDDiskWearInfo(1048576,640000),	
			 "INTEL SSDSC2BA20":SSDDiskWearInfo(1048576,640000),	
			 "INTEL SSDSA2BW16":SSDDiskWearInfo(1048576,640000), # YT 160G-ss
			 "INTEL SSDSA2BW60":SSDDiskWearInfo(1048576,640000), # YT 600G-mgmt
			 "INTEL SSDSC2BB30":SSDDiskWearInfo(2097152,640000), # WV 300GB 
			 "INTEL SSDSC2BB16":SSDDiskWearInfo(2097152,640000), # WV 160GB
			 "INTEL SSDSC2BB08":SSDDiskWearInfo(2097152,640000)  # WV 80GB
		       }
