...
/* rbt: functions from tdbback.c */
char *add_suffix(const char *name, const char *suffix);
int verify_tdb(const char *fname, const char *bak_name, const struct tdb_logging_context *log_ctx);
int backup_tdb(const char *old_name, const char *new_name, int hash_size, const struct tdb_logging_context *log_ctx);
int check_corrupt(const char *fname, const struct tdb_logging_context *log_ctx);
