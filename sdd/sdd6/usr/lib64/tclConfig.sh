...
TCL_EXTRA_CFLAGS='-O2 -g -pipe -m64'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/usr/lib64 -ltcl8.4${TCL_DBGX}'
...
TCL_PACKAGE_PATH='/usr/lib64 /usr/share'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/usr/lib64 -ltclstub8.4${TCL_DBGX}'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/usr/lib64 -ltclstub8.4${TCL_DBGX}'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/usr/lib64/libtclstub8.4${TCL_DBGX}.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/usr/lib64/libtclstub8.4${TCL_DBGX}.a'
