...
#
#  Filename:  $Source$
#  Revision:  $Revision: 68156 $
#  Date:      $Date: 2010-07-23 13:56:15 -0700 (Fri, 23 Jul 2010) $
#  Author:    $Author: totran $
# 
...
RSP_COMMAND_PARAMS="$RSP_ROOT_DIR $RSP_VMWARE_STORAGE $RSP_INSTALL_TARBALL $RSP_INSTALL_DISKLIB_TARBALL"
